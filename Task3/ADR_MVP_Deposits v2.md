...
Ниже приведены ключевые Use Cases для MVP открытия депозитов в интернет‑банке и на сайте банка. Каждый сценарий отражает основные действия пользователей и взаимодействие систем.
